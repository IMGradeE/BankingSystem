...
var options = {
  host: dbConnectionInfo.rootConInfo.host,
  port: dbConnectionInfo.rootConInfo.port,
  user: dbConnectionInfo.rootConInfo.user,
  password: dbConnectionInfo.rootConInfo.password,
